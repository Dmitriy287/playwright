...
def sort_products(page: Page):
    def sort_products_function():
        ...
        # page.click(locator_sort_low)
        page.select_option(locator_sort_2, value=data_sort_option_low_2)
        page.screenshot(path='screenshot/sort.png')
...
def get_product(page: Page):
    def get_product_function():
        ...
        page.screenshot(path='screenshot/get.png')
